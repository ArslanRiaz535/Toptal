  ...
  <Box bgcolor="#f6f8fb" py={12}>
    <Container maxWidth="lg">
       ...
       <Box display='flex' justifyContent='center' mt={5}>
         ...
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" height='21px' width='22px' viewBox="0 0 22 20" class="Tu2GcmvX"><path fill="#E59C01" d="m11 0 2.47 7.6h7.992l-6.466 4.698 2.47 7.601L11 15.202l-6.466 4.697 2.47-7.6L.538 7.6H8.53L11 0Z"></path></svg>
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" height='21px' width='22px' viewBox="0 0 22 20" class="Tu2GcmvX"><path fill="#E59C01" d="m11 0 2.47 7.6h7.992l-6.466 4.698 2.47 7.601L11 15.202l-6.466 4.697 2.47-7.6L.538 7.6H8.53L11 0Z"></path></svg>
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" height='21px' width='22px' viewBox="0 0 22 20" class="Tu2GcmvX"><path fill="#E59C01" d="m11 0 2.47 7.6h7.992l-6.466 4.698 2.47 7.601L11 15.202l-6.466 4.697 2.47-7.6L.538 7.6H8.53L11 0Z"></path></svg>
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" height='21px' width='22px' viewBox="0 0 22 20" class="Tu2GcmvX"><path fill="#E59C01" d="m11 0 2.47 7.6h7.992l-6.466 4.698 2.47 7.601L11 15.202l-6.466 4.697 2.47-7.6L.538 7.6H8.53L11 0Z"></path></svg>
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" height='21px' width='22px' viewBox="0 0 22 20" class="Tu2GcmvX"><path fill="#C4C6CA" d="M13.47 7.6 11 0v15.202l6.466 4.697-2.47-7.601L21.462 7.6H13.47Z"></path><path fill="#E59C01" d="M8.53 7.6 11 0v15.202l-6.466 4.697 2.47-7.601L.538 7.6H8.53Z"></path></svg>
