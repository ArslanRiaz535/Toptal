        ...
        <Container maxWidth={false} sx={{ width: '1250px', maxWidth: '100%', marginTop: '180px' }}>
          ...
          >
              ...
              <Box display='flex' alignItems='center' justifyContent='center' sx={{ border: '1px solid #183A9E', borderRadius: '4px', cursor: 'pointer' }} padding='7px 25px' bgcolor='#183A9E' color='white'>
                <Box>
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" fill="none" >
                    <path fill="#FFF" fillRule="evenodd" d="M10.1 1.125 6.875 15.1l-.975-.225L9.125.9l.975.225ZM1.63 8l3.074-4.1-.8-.6L.38 8l3.525 4.702.8-.6L1.63 8Zm9.674 4.103.8.6L15.63 8l-3.525-4.7-.8.6L14.38 8l-3.075 4.103Z" clipRule="evenodd"></path>
                  </svg>
                </Box>
                ...
                <Box>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" >
                    <g stroke="#204ECF" clipPath="url(#designer_icon_id)">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5.721 6.928V.546L.381 8.14s2.925 2.54 2.925 5.215v1.807M5.748.523l5.341 7.594s-2.952 2.54-2.952 5.215v1.807m-.257-1.862H3.338"></path>
                    </g>
                    <defs>
            ...
            <Grid item md={2} sx={{ cursor: 'pointer' }} borderRight='1px solid #D8D9DC'>
              <Box display='flex' alignItems='center' justifyContent='center'>
                <Box>
                  <svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" width="20" height="20" >
