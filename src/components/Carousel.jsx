...
const items = [
  ...
  { 
    imgSrc: '/Carousel/images (11).avif',
     ...
     svg:   <svg width="19" height="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.1021 1.12957L9.87051 23.1024L8.8977 22.8708L14.1293 0.897949L15.1021 1.12957ZM1.6551 12.0002L6.70851 5.93569L5.94026 5.29553L0.353516 12.0001L5.94015 18.7067L6.7085 18.0667L1.6551 12.0002ZM22.3535 12.0002L17.3001 18.0667L18.0685 18.7067L23.6551 12.0001L18.0683 5.29553L17.3001 5.93569L22.3535 12.0002Z" fill="#455065"></path></svg>
    },
  { 
    imgSrc: '/Carousel/images (12).avif',
     ...
     svg:   <svg width="19" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"><path fill-rule="evenodd" clip-rule="evenodd" d="M20 3H19V21H15V7H14V21H10V11H9V21H5V15H4V21H2V22H22V21H20V3Z" fill="#455065"></path></svg>
    },
  { 
  ...
  { 
    imgSrc: '/Carousel/images (14).avif',
     ...
     svg:   <svg width="19" height="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"><path d="M11.9463 12.9597C12.7008 12.9597 13.3125 12.348 13.3125 11.5935C13.3125 10.839 12.7008 10.2273 11.9463 10.2273C11.1918 10.2273 10.5801 10.839 10.5801 11.5935C10.5801 12.348 11.1918 12.9597 11.9463 12.9597Z" stroke="#455065"></path><path d="M11.9811 10.7506V2.03142L4.68555 12.4064C4.68555 12.4064 8.68172 15.8753 8.68172 19.5313V22M12.018 2L19.315 12.375C19.315 12.375 15.2819 15.8438 15.2819 19.4998V21.9686M14.9308 19.4247H8.72544" stroke="#455065" stroke-linecap="round" stroke-linejoin="round"></path></svg> 
    },
  { 
  ...
  { 
    imgSrc: '/Carousel/images (16).avif',
     ...
     svg:   <svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" width="18" height="18" class="w-4 h-4"><path d="m20.57 20.21-3.35-3.36.71-.7 2.64 2.64 6.65-6.64.71.7z" fill="#455065"></path><path d="m14.57 29.06-12.5-6.25v-15.62l12.5-6.25 12.3 6.16v.8l-12.3 6.16-11.5-5.75v13.88l11.5 5.75 11.78-5.89.45.89-12.22 6.11zm-10.88-21.56 10.88 5.44 10.86-5.44-10.86-5.44z" fill="#455065"></path><path d="m0 0h30v30h-30z" fill="none"></path></svg>
    },
  { 
